...
@dp.message_handler(text='💶📲🧔‍♂️ Мобильный Саша 💶📲🧔‍♂️')
async def run(message: types.Message, state: FSMContext):
...
@dp.message_handler(text='☕️🍩 Кафе ☕️🍩')
async def run(message: types.Message, state: FSMContext):
